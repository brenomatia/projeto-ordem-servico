    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('request_login_empresa', ['empresa'=>$empresa->name]) }}" method="post">
                    @csrf
                ...
                <div class="input-group">
                    <a href="{{ URL::route('cadastro_empresa', ['empresa'=>$empresa->name]) }}" class="col-12 btn btn-primary">Cadastrar</a>
                </div>
