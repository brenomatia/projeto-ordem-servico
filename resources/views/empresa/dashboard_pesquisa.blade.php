        ...
        <div class="container col-12" style="justify-content: center;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" name="start_date" placeholder="Data de Início" riquered>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                            <input type="date" class="form-control" name="end_date" placeholder="Data Final" riquered>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ URL::route('dashboard_empresa', ['empresa'=>$empresa->name]) }}"><button type="button" class="btn btn-danger col-12"><i class="fa-solid fa-circle-arrow-left"></i> VOLTAR</button></a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-2 mb-2">
                    <div class="card">
                        <div class="container" style="text-align: center"><label class="p-3">Comparativo resultante</label></div>
                        <div class="chart" style="border: 1px solid #dee2e6; padding: 10px;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var chart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: {!! json_encode($labelsVendasPersonalizadas) !!},
                    datasets: [{
                        label: 'Vendas Personalizadas (Mês Atual)',
                        data: {!! json_encode($totalVendasPersonalizadas) !!},
                        backgroundColor: 'rgba(54, 162, 235, 0.2)', // Azul claro
                        borderColor: 'rgba(54, 162, 235, 1)', // Azul
                        borderWidth: 1
                    }, {
                        label: 'Vendas Personalizadas (Mês Anterior)',
                        data: {!! json_encode($totalVendasPersonalizadasMesAnterior) !!},
