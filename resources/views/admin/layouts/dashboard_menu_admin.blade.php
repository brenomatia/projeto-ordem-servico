...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand text-center">
      <img src="{{ asset('logos/logo.png') }}" class="brand-image mt-1 mb-5" style="opacity: .8; width: 60px;">
    </div>
  ...
  <aside class="control-sidebar">
    ...
    <div class="container text-center mt-1 bg-white p-3 rounded">
      <a href="{{ route('logout') }}"><button class="btn btn-danger text-white col-12"><i class="fa-solid fa-right-from-bracket"></i> Logout</button></a>
    </div>
